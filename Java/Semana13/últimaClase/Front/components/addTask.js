...
export const addTask = (event) => {
    event.preventDefault();//evita que se recargue la pagina borrando la informacion
    ...
    const taskObj = {
       ...
       export const createTask = ({ id, title, time,finished}) => {
        ...
        const task = document.creatElement("li"); //creo un elemento li
        ...
        titleTask.innerText = title; //agregamos al titleTask el valor del input
